...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nolearn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14518&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nolearn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nolearn` can be installed with:

```
conda install nolearn
```

It is possible to list all of the versions of `nolearn` available on your platform with:
